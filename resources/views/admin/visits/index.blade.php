        ...
        <table class="table table-striped table-sm">
            ...
            @foreach($visits as $visit)
                <tr>
                    ...
                    @if(Illuminate\Support\Str::length($url= Illuminate\Support\Str::after(
                        Illuminate\Support\Str::limit($visit->referer, 50, $end='...'), url('/')) )>1)
                        <td>{{$url}}</td>
                    ...
                    @if($url= Illuminate\Support\Str::after(Illuminate\Support\Str::limit($visit->url, 50, $end='...'), url('/')))
                        <td>{{$url}}</td>
                    @else
                        <td><span class="text-warning">home page</span></td>
                    @endif
                    ...
                    <td>{{$visit->created_at->setTimezone('Asia/Tehran')->format('m/d h:i')}}</td>
